...
void dfu_service_handle_control_point_req_exit_cb_app(uint8_t opcode);

P_FUN_DFU_OPCODE_CB dfu_service_handle_control_point_req_exit_cb =
    dfu_service_handle_control_point_req_exit_cb_app;
...
#if (SLAVE_REQUEST_UPDATE_COON_PARA ==1)
