...
#define LV_HOR_RES_MAX       228
#define LV_VER_RES_MAX       460
/*====================
   COLOR SETTINGS
 *====================*/
...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (84U * 1024U)          /*[bytes]*/
...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "am_util_delay.h"         /*Header for the system time function*/
